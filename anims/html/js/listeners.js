...
doc.getElementById('home').addEventListener('mouseover', _ => changeInfo(true, 'Principal', 'Mostrar todas las animaciones.'));
...
doc.getElementById('settings').addEventListener('mouseover', _ => changeInfo(true, 'Ajustes', 'Configuración de bailes.'));
...
doc.getElementById('exit').addEventListener('mouseover', _ => changeInfo(true, 'salir', 'Salir del menu de animaciones.'));
...
doc.getElementById('favorite').addEventListener('mouseover', _ => changeInfo(true, 'favoritos', 'Ver animaciones favoritas.'));
...
doc.getElementById('dances').addEventListener('mouseover', _ => changeInfo(true, 'bailes', 'Ver Bailes.'));
...
doc.getElementById('props').addEventListener('mouseover', _ => changeInfo(true, 'objetos', 'Objetos.'));
...
doc.getElementById('scenarios').addEventListener('mouseover', _ => changeInfo(true, 'Guiones', 'guiones.'));
...
doc.getElementById('walks').addEventListener('mouseover', _ => changeInfo(true, 'caminar', 'Formas de caminar.'));
...
doc.getElementById('expressions').addEventListener('mouseover', _ => changeInfo(true, 'expresiones', 'Expresiones faciales.'));
...
doc.getElementById('shared').addEventListener('mouseover', _ => changeInfo(true, 'compartido', 'Animaciones compartidas.'));
...
doc.getElementById('cancel').addEventListener('mouseover', _ => changeInfo(true, 'Cancelar', 'Cancelar animación actual.'));
...
doc.getElementById('delete').addEventListener('mouseover', _ => changeInfo(true, 'Borrar objetos', 'Borrar todos los objetos bugueados.'));
...
doc.getElementById('movement').addEventListener('mouseover', _ => changeInfo(true, 'Movimiento', 'Muevete mientras bailas (not shared).'));
...
doc.getElementById('loop').addEventListener('mouseover', _ => changeInfo(true, 'bucle', 'Haz la animación infinita.'));
