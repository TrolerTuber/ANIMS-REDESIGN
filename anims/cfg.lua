...
cfg = {
    ...
    commandSuggestion = 'Abrir panel de emotes', -- Open the animations panel suggestion
    commandNameEmote = 'e', -- Play an animation by command
    commandNameSuggestion = 'Hacer emote', -- Play an animation by command suggestion
    keyActive = true, -- Use key for opening the panel
    keyLetter = 'F4', -- Which key for opening the panel if cfg.keyActive is true
    keySuggestion = 'Emotes', -- Suggestion on keybind mapping
    ...
    animActive = false,
    animDuration = 15000, -- You can change this but I recommend not to.
    animLoop = false,
    animMovement = false,
